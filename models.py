...
class User(Base):
    ...
    user_id = Column('user_id', String(36, collation='ja_JP.utf8'), nullable=False, comment='ユーザーUUID')
...
class Tenant(Base):
    ...
    id = Column('id', Integer, primary_key=True, autoincrement=True, comment='サロゲートキー')
    tenant_id = Column('tenant_id', String(64, collation='ja_JP.utf8'), nullable=False, comment='会社コード')
    uuid = Column('uuid', String(36, collation='ja_JP.utf8'), nullable=False, unique=True, default=lambda: str(uuid.uuid4()), comment='テナントUUID')
    create_employee_code = Column('create_employee_code', String(10, collation='ja_JP.utf8'), nullable=False, comment='作成者ユーザーコード')
    update_date = Column('update_date', TIMESTAMP, nullable=False, default=datetime.now, onupdate=datetime.now, comment='更新日時')
    update_employee_code = Column('update_employee_code', String(10, collation='ja_JP.utf8'), nullable=False, comment='更新者ユーザーコード')
    update_count = Column('update_count', Integer, nullable=False, comment='更新回数')
...
class Employee(Base):
    ...
    id = Column('id', Integer, primary_key=True, autoincrement=True, comment='サロゲートキー')
    employee_uuid = Column('employee_uuid', String(36, collation='ja_JP.utf8'), nullable=False, comment='従業員UUID')
    user_id = Column('user_id', String(36, collation='ja_JP.utf8'), nullable=False, comment='UserテーブルのUUID')
    tenant_uuid = Column('tenant_uuid', String(36, collation='ja_JP.utf8'), nullable=False, comment='TenantテーブルのUUID')
    employee_code = Column('employee_code', String(10, collation='ja_JP.utf8'), nullable=False, comment='会社ごとの社員番号')
    create_employee_code = Column('create_employee_code', String(10, collation='ja_JP.utf8'), nullable=False, comment='作成者ユーザーコード')
    update_date = Column('update_date', TIMESTAMP, nullable=False, default=datetime.now, onupdate=datetime.now, comment='更新日時')
    update_employee_code = Column('update_employee_code', String(10, collation='ja_JP.utf8'), nullable=False, comment='更新者ユーザーコード')
    update_count = Column('update_count', Integer, nullable=False, comment='更新回数')
...
class TimeCardLayer(Base):
    ...
    id = Column('id', Integer, primary_key=True, autoincrement=True, comment='サロゲートキー')
    employee_uuid = Column('employee_uuid', String(36, collation='ja_JP.utf8'), nullable=False, index=True, comment='ユーザーコード')
...
class TimeCardLayerHistory(Base):
    ...
    employee_uuid = Column('employee_uuid', String(36, collation='ja_JP.utf8'), nullable=False, comment='ユーザーコード')
    target_date = Column('target_date', Date, nullable=False, comment='対象日')
    work_schedule_code = Column('work_schedule_code', String(10, collation='ja_JP.utf8'), nullable=True, comment='勤務体系コード')
    stamping_start_time = Column('stamping_start_time', String(8, collation='ja_JP.utf8'), nullable=True, comment='出勤時間')
    stamping_end_time = Column('stamping_end_time', String(8, collation='ja_JP.utf8'), nullable=True, comment='退勤時間')
